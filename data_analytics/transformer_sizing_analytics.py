...
plt.fill_between(df.index, df['capacity'], df['peak_load'], hatch='//////', color='lightgray', edgecolor='black', facecolor='none', where=df.index <= intersection_index, alpha=0.3, label='safety margin')
plt.xlim(0, None)
plt.ylim(0, None)
